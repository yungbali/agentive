...
const ActionCard: React.FC<ActionCardProps> = ({ icon, title, bgColor, iconColor }) => {
      ...
      case 'watchlist':
        return (
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
            <path d="M7 1.5L8.79 5.17L12.5 5.82L9.75 8.49L10.58 12.5L7 10.59L3.42 12.5L4.25 8.49L1.5 5.82L5.21 5.17L7 1.5Z" 
  ...
  return (
    <div className="relative w-[155px] h-[54px] bg-white/80 rounded-[25px]">
      <div className={`absolute w-[32px] h-[32px] left-[11px] top-[11px] ${bgColor} rounded-full 
